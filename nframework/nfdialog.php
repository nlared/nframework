    ...
    <div class="container">
        ...
        <div class="box shadow-large">
            ...
            <div class="grid">
                ...
                ?>
                <div class="row">
                    <div class="cell-md-2 offset-md-8"><a href="/nftables/<?= $tabla->nfcollection ?>" class="button primary btn btn-primary w-100"><span class="mif-exit"></span>&nbsp;<?= $nframework->language['close']  ?></a></div>
