...
class Constants
{
    /*const CLIENT_ID =  $config['microsoft_oauth_client_id'];
    const CLIENT_SECRET = $config['microsoft_oauth_client_secret'];
    const REDIRECT_URI = 'https://'.$_SERVER['HTTP_HOST'].'/login-microsoft/oauth.php';//'http://localhost:8000/oauth.php';*/
