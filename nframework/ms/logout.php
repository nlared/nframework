...
//$logout_url = sprintf('%s/oauth2/%sv2.0/logout?&post_logout_redirect_uri=%s', Constants::AUTHORITY_URL, Constants::CLIENT_ID, $return_to);
...
//https://login.microsoftonline.com/williamfiddes.onmicrosoft.com/oauth2/v2.0/logout?post_logout_redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient